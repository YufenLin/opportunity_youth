/*
    ...
    Purpose:    Count the number of 2017 population in opportunity youth in South King County
                ...
                age from 16 to 24                 
    Note: TODO: show '3_Degree' = 0 which count(*) = 0
                Try to query all table in single query command
*/
...
FROM(
    SELECT pwgtp, --weight
        ...
        END As diploma
    FROM pums_2017
    WHERE ((puma BETWEEN '11610' AND '11614') OR puma = '11604' OR puma = '11605') -- PUMA of South King County
